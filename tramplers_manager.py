...
class App(tk.Tk):
    ...
    def _build_layout(self):
        ...
        self.tree.column("added", width=140, anchor="w", stretch=False)
        self.tree.column("size", width=90, anchor="w", stretch=False)
        self.tree.column("notes", width=120, anchor="w", stretch=False)
